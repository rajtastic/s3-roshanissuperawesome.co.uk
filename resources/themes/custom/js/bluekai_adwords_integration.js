...
window.bk_so_integration.config.adwords_conversionid = 871982529; // Set to AdWords Conversion ID (See https://support.google.com/adwords/answer/2476688?hl=en-GB for help - the value will show where like "var google_conversion_id = 871982529";)
window.bk_so_integration.config.adwords_trim_audiencename_trim_length = 16; // Set to 0 to not trim audince names being used as custom parameter names (or to a number to trim to X characters). Google recommends 16 characters but doesn't seem to mind
...
window.bk_so_integration.config.enable_google_optimize = true; // set to true to enable integration
